...
But what’s the rest? --- **I want to run several test cases in one Test Suite with different browser type --- Firefox, Edge Chromium and Chrome.**
...
Please read the source codes. The inline comments describe a lot.
...
I don’t think the original idea (run Test Cases with different borwser in a Test Suite) is pragmatic. It is not useful.
