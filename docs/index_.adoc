:PAGES_URL: https://kazurayam.github.io/SpecifyingBrowserForIndividualTestCasesWithATestSuite
:RES:
...
Katalon Studio does not support this. As the following screenshot shows,
